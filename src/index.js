...
let ln
setTimeout(() => {
    let input = document.querySelector("#region")
    ...
    submit.addEventListener("click", () => {
        if(data != ""){
            ...
            if(countriesArray.includes(input.value) == true){
                let sort = countriesArray.indexOf(input.value)
                ln = countries[sort].latitude
                lt = countries[sort].longitude
            }
        }
    })
}, 100)
